...
- **Cited Paper**: [[2024_iTransformer_Inverted_Transformers_Effective_Time_Series]]
...
- **Cited Paper**: [[2026_Mamba_3_Sequence_Modeling]]
...
- **Cited Paper**: [[2021_Autoformer_Decomposition_Transformers_AutoCorrelation]]
...
- **Cited Paper**: [[2023_TimesNet_Temporal_2D_Variation_Modeling]]
...
- **Cited Paper**: [[2023_Crossformer_Cross_Dimension_Dependency]]
...
- **Cited Paper**: [[2021_Informer_Beyond_Efficient_Transformer]]
...
- **Cited Paper**: [[2023_DLinear_Are_Transformers_Effective_LTSF]]
...
- **Cited Paper**: [[2021_TFT_Temporal_Fusion_Transformers]]
- **What you can reuse**:
...
- **Cited Paper**: [[2024_TiDE_Long_Term_Forecasting]]
- **What you can reuse**:
...
- **Cited Paper**: [[2023_PatchTST_A_Time_Series_is_Worth_64_Words]]
- **What you can reuse**:
...
- **Cited Paper**: [[2017_MAML_Model_Agnostic_Meta_Learning]]
- **What you can reuse**:
  - *Code*: first-order inner/outer gradient loop — the template behind few-shot adaptation schemes (cf. Reptile-based [[2023_MetaProbformer_EV_Load]]).
...
- **Cited Paper**: [[2018_Empirical_TCN_Sequence_Modeling]]
- **What you can reuse**:
...
- **Cited Paper**: [[2022_RevIN_Reversible_Instance_Normalization]]
- **What you can reuse**:
...
- **Cited Paper**: [[2023_NHiTS_Neural_Hierarchical_Interpolation]]
- **What you can reuse**:
...
- **Cited Paper**: [[2024_TimeMachine_Mamba_Long_Term_Forecasting]]
- **What you can reuse**:
...
- **Cited Paper**: [[2024_BiMamba_Bidirectional_Mamba_Forecasting]]
- **What you can reuse**:
...
- **Cited Paper**: [[2024_KAN_Kolmogorov_Arnold_Networks]]
- **What you can reuse**:
  - *Code*: KAN layers with learnable B-spline edge activations, grid-extension refinement, sparsification/pruning/symbolification pipeline for interpretable small models (e.g., KAN decoders as in [[2026_Mamba_KAN_HyKANet_EV]]).
...
- **Cited Paper**: [[2024_PowerMamba_Power_Systems_SSM]]
- **What you can reuse**:
...
- **Cited Paper**: [[2026_SSM_Transformer_LSTM_Grid_Benchmark]]
- **What you can reuse**:
...
- **Cited Paper**: [[2025_Sundial_Highly_Capable_Time_Series_Foundation_Models]]
- **What you can reuse**:
...
### Moirai 2.0 (When Less Is More — Decoder-Only Quantile TSFM)

- **Repository URL**: `https://github.com/SalesforceAIResearch/uni2ts`
- **Weights (Hugging Face)**: `https://huggingface.co/Salesforce/moirai-2.0-R-small` (also base 87.1M / large 305M variants)
- **Cited Paper**: [[2026_Moirai_2_When_Less_Is_More]]
- **What you can reuse**: *Code*: decoder-only patched Transformer (quantile head 9 levels, multi-token prediction, recursive multi-quantile beam Alg. 1, patch masking 50%); *Data*: 36M/295B pretraining pipeline (GIFT-Eval Pretrain + Mixup + KernelSynth + internal telemetry) + GIFT-Eval 97-task replication code at `gift-eval` notebooks; *Pretrained*: 3 checkpoints ranked 5th/6th on GIFT-Eval among 37 FMs, 30x smaller / 2x faster than Moirai-Large.

### MOIRAI 1.0 (Masked Encoder-based Universal Time Series Forecasting Transformer)

- **Repository URL**: `https://github.com/SalesforceAIResearch/uni2ts`
- **Weights (Hugging Face)**: `https://huggingface.co/Salesforce/moirai-1.0-R-small` (also `moirai-1.0-R-base` 91M, `moirai-1.0-R-large` 311M)
- **Cited Paper**: [[2024_Unified_Training_Universal_Time_Series_Transformers]]
- **What you can reuse**:
  - *Architecture Code*: Multi-patch size input/output projection layers ($8, 16, 32, 64, 128$), Any-variate Attention with binary variate biases, Rotary Position Embeddings (RoPE), and 4-distribution parametric mixture head (Student-$t$, log-normal, negative binomial, low-variance normal).
  - *Data Pipeline*: Apache Arrow data loader with sequence packing (reduces padding from $61\%$ to $0.38\%$) on 27.6B observation LOTSA archive.
  - *Pretrained Checkpoints*: 3 model sizes (14M, 91M, 311M) for zero-shot probabilistic and point forecasting across arbitrary variates.

## 📚 Literature Usage
- [[2026_TiRex_2_Multivariate_Streaming_Forecasting]] — Official repository: `https://github.com/NX-AI/tirex` (NXAI / JKU Linz)
- [[2026_TS_ICL_Time_Indexed_Foundation_Model]] — Official GitHub repository by EDF Lab: `https://github.com/EDF-Lab/ts-icl`
- [[2026_FlowState_Sampling_Rate_Equivariant_Forecasting]] — Official HuggingFace weights & code: `https://huggingface.co/ibm-research/flowstate`
- [[2025_TiRex_Zero_Shot_Forecasting_In_Context_Learning]] — Official PyTorch & xLSTM codebase and pretrained model weights: `https://github.com/NX-AI/tirex`
