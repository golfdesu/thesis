...
## Literature Usage
- [[2026_Toto_2_Scaling_Era]] — Second pretraining source (with Datadog observability). Proxy sweep optimum: 57.5%% synthetic / 42.5%% observability (public data excluded entirely for base models).
