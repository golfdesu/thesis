...
## 🔗 Access Links
- Publicly available as the "REFIT smart-meter dataset" (Murray et al. 2017); DOI listed in the paper note of [[2025_Benchmark_Foundation_Models]].

## 📚 Used By
- [[2025_Personalized_Federated_Learning]] — PF-HoLo personalized federated learning under imbalanced household data (−13.41% MSE / −11.33% MAE vs FedAvg).
- [[2025_Benchmark_Foundation_Models]] — Household electricity benchmark for time-series foundation models.
