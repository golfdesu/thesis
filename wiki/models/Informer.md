...
- **Forecasting Horizon**: [[Long_Term]] (up to 720+ steps; predict-1440 demonstrated).
...
- [[2023_Huang_MetaProbformer_EV_Load]] — Informer adapted into the Gaussian-output [[Probformer]]; plain Informer best non-meta baseline (ordering MetaProbformer < MetaTransformer < Informer < LSTM < Transformer < ARIMA).
