...
- **Pinball Loss Function for Quantile $q$**:
  $$L_{\text{PB}}(q, y, \hat{y}^q) = \begin{cases} (1-q)(y - \hat{y}^q) & \hat{y}^q \ge y \\ q(y - \hat{y}^q) & \hat{y}^q < y \end{cases}$$

## Literature References
- [[2024_Ali_MQ_TCN_Transfer_Learning_EV]] - Proposed MQ-TCN with inductive transfer learning for data-scarce EV charging sites.
