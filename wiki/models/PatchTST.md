...
- [[2024_Das_TimesFM_Decoder_Only_Foundation_Model]] — Zero-shot baseline: patched predecessor; TimesFM decoder-only beats patched encoder-decoder PatchTST(ZS) on Monash and ties on ETT at same 200M/FLOPS; p=32 vs PatchTST stride 16 comparison in A.4.
- [[2026_Khwaja_Toto_2_Scaling_Era]] — GIFT-Eval external competitor (CRPS rank 23.1, 4th behind Toto 2.0 top-3 20.3/21.1/21.4); TIME 4th/5th; patching predecessor ablated vs TimesFM decoder-only.
