...
- [[2026_CNN_LSTM_Attention_Fast_Charging]] - Proposed CNN-LSTM-Transformer for 24h and 48h multi-step fast-charging load forecasting.
- 2023 — [[2023_Combined_Deep_Learning_EV_Station_STLF]] : serial CNN→LSTM→Transformer on the Boulder ST1 station (24-h lookback, single-step ahead) achieves RMSE 0.300 / MAE 0.120, beating every pairwise combination; notably LSTM+Transformer *without* CNN is worst (RMSE 0.428), showing CNN local feature extraction is essential before attention.
