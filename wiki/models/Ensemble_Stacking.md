...
- [[2026_Mansour_Hybrid_XGBoost_BiLSTM_EV_Load]] - XGBoost-BiLSTM stacking ensemble with an XGBoost meta-learner for hourly station-level EV charging load; removing the meta-learner raised MAE by +30.5% (2.687→3.507 kWh), and it led walk-forward validation with mean MAE 2.535 kWh.
