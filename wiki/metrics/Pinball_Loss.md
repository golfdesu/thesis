...
| Paper | Result |
|-------|--------|
| 2017 — [[2017_Liu_QRA_Sister_Forecasts_Probabilistic_Load]] | QRA combination selected by pinball score (best config QRA(8), 183-day calibration) — dominated all sister benchmarks on pinball and [[Winkler_Score]]. |
| 2019 — [[2019_Toubeau_Deep_Probabilistic_Scheduling_Power_Markets]] | Non-parametric BLSTM trained by minimizing total pinball loss over quantile set $Q$; compared against parametric Gaussian likelihood training. |
| 2021 — [[2021_Zhang_Probabilistic_Queuing_EV_Load]] | WT-CNN achieved lowest pinball loss among all methods at PINC 90/95/99% vs quantile regression benchmark. |
| 2022 — [[2022_Cao_Robust_Deep_Gaussian_Process_Load]] | Improved quantile/pinball objective used to train probabilistic DGP load forecasts. |
| 2024 — [[2024_Ali_MQ_TCN_Transfer_Learning_EV]] | Pinball loss is the MQ-TCN training objective (JPL Pinball 2.28, NREL 1.86); paired with [[PICP]]/[[Winkler_Score]] evaluation. |
| 2024 — [[2024_Cao_Feature_Enhanced_Probabilistic_EV_Load]] | Enhanced pinball loss (Eqs. 28–29) with feature-reweighted FEDM network. |
| 2025 — [[2025_Matrone_QR_LSTM_Attention_EV_Load]] | Minimized separately per quantile q20/q50/q80: best model cut pinball by 81.39%/62.09%/68.04% vs persistence. |
| 2026 — [[2026_MoghadamDost_TFT_Conformal_Environmental_EV_Load]] | TFT quantile head {0.1, 0.5, 0.9} trained with summed pinball loss (Eqs. 3–4) over Palo Alto hourly/daily horizons; P50 as point forecast, [P10, P90] as band. |
| 2026 — [[2026_Singh_MetaLearning_Informer_Probabilistic_EV]] | Pinball-derived Q50/Q90 outputs used to verify Gaussian-head calibration; MAML-Informer cuts RMSE50 up to 51.21%. |
