...
| Paper | Result |
|-------|--------|
| 2019 — [[2019_Zhu_EV_Load_Forecasting]] | R² reported for minute-level Bi-LSTM/SAE EV load forecasting. |
...
| 2025 — [[2025_Mansour_Hybrid_XGBoost_BiLSTM_EV_Load]] | Hybrid 3 test R² 0.6395 vs BiLSTM 0.5950; walk-forward mean R² 0.6289; Transformer negative (R² −0.007). |
