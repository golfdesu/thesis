...
| **Conformal variant** | Distribution-free finite-sample guarantees via [[Split_Conformal_Prediction]] / ICP; joint trajectory-level coverage needs Bonferroni correction |
