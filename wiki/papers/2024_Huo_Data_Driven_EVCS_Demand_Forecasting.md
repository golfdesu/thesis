...
- **[14] Huang, Wu, Boulet, IEEE EPEC 2020** — ensemble ANN+RNN+LSTM for next-hour station load (related aggregation-level approach; cf. [[2020_Huang_Ensemble_EV_Load]]).
- **[12] Arias & Bae, Applied Energy 2016**; **[13] Yi et al. 2021** (LSTM regional monthly EV load); **[15][16]** SVM/KNN predecessors.
- Related vault papers: [[2024_Li_TOU_Price_Meteorology_EV_Charging_Load]] (adds TOU price/weather exogenous features to short-term station forecasting), [[2024_Ma_LASSO_BPNN_Mid_Term_EV_Load]] (feature selection + MLP-family model, mid-term horizon), [[2021_VanKriekinge_Day_Ahead_EV_Demand]] (day-ahead station-level forecasting with calendar features absent here).
