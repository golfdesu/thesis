...
- [[2024_EV_Load_Forecasting_DAM]] — cited [7]: systematic day-ahead EV load forecasting review; XGBoost/MLP best performers make no distributional assumptions → motivates GBT base model here.
...
- *Note:* [[2021_Conformal_Time_Series_Forecasting]] is **not** cited by this paper (linked here only as vault context for conformal time-series lineage).
