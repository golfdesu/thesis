...
- [[2021_Informer_Beyond_Efficient_Transformer]] — Zhou et al., Informer / ProbSparse attention / distilling (ref. [26])
- [[2018_Empirical_TCN_Sequence_Modeling]] — Bai et al., TCN architecture used as experts (ref. [24])
- [[2023_Crossformer_Cross_Dimension_Dependency]] / related Transformer line — Vaswani et al., Attention Is All You Need (ref. [17], cf. [[2017_Attention_Is_All_You_Need]])
- [[2023_NHiTS_Neural_Hierarchical_Interpolation]] — N-HiTS baseline (ref. [40])
- [[2023_PatchTST_A_Time_Series_is_Worth_64_Words]] — PatchTST baseline (ref. [41])
- [[2024_iTransformer_Inverted_Transformers_Effective_Time_Series]] — iTransformer baseline (ref. [42])
...
Full extracted bibliography for this paper: [[2025_ResMMoT_Informer_Time_Series_refs]]
