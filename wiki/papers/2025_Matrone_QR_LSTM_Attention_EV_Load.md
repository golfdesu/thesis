...
- Zhu et al. (2019), *Electric Vehicle Charging Load Forecasting: A Comparative Study of Deep Learning Approaches* (Energies) — see [[2019_Electric_Vehicle_Charging_Load_Forecasting_A_Comparative_Study_of_Deep_Learning_Approaches]], ref [6].
