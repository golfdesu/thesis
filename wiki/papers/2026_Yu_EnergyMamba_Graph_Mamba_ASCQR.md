...
- Builds directly on **Mamba** (Gu & Dao, COLM 2024) [ref 10] — the selective SSM backbone; see vault page [[Mamba_SSM]]. Related Mamba-family baselines it cites: G-Mamba (Graph-Mamba, arXiv 2402.00789) and U-Mamba (arXiv 2401.04722); closest prior bidirectional-Mamba forecasting work in the vault: [[2024_Liang_BiMamba_Bidirectional_Mamba_Forecasting]] (not cited by this paper).
- Uncertainty lineage: **Conformalized Quantile Regression** (Romano, Patterson & Candès, NeurIPS 2019) [ref 36] → static CQR baseline; **Adaptive Conformal Inference** (Gibbs & Candès, NeurIPS 2021) [ref 9] → the α̃_t update rule in Eq. (24). Vault anchor for TS conformal: [[2021_Stankeviciute_Conformal_Time_Series_Forecasting]]; DER-side adaptive recalibration: [[2024_Zhou_Conformal_Prediction_DER]].
