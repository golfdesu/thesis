...
models_used: ["[[PowerMamba]]", "[[Mamba_SSM]]", "[[RevIN]]", "[[iTransformer]]", "[[PatchTST]]", "[[DLinear]]", "[[Autoformer]]", "[[TimesNet]]", "[[2024_TimeMachine_Mamba_Long_Term_Forecasting]]"]
...
- [[2024_TimeMachine_Mamba_Long_Term_Forecasting]] — closest Mamba-based competitor; strongest baseline throughout (cited as [37])
- [[2024_BiMamba_Bidirectional_Mamba_Forecasting]] — Bi-Mamba+/Bi-Mamba4ts bidirectional processing for intra-/inter-series correlations [36]
