...
datasets_used: ["[[Electricity_Dataset]]", "[[Traffic_Dataset]]", "[[Weather_Dataset]]", "[[ETTh1]]", "[[ETTh2]]", "[[ETTm1]]", "[[ETTm2]]", "[[M5_Dataset]]", "Synthetic LDS Dataset"]
...
- [[2023_Zeng_DLinear_Are_Transformers_Effective_LTSF]] — linear-model motivation; DLinear subclass of TiDE
- [[2023_Nie_PatchTST_A_Time_Series_is_Worth_64_Words]] — strongest baseline; source of reported numbers
- [[2021_Wu_Autoformer_Decomposition_Transformers_AutoCorrelation]] — benchmark baselines + dataset protocol
- [[2021_Zhou_Informer_Beyond_Efficient_Transformer]] — ProbSparse attention baseline
- [[2019_Li_LogSparse_Enhancing_Locality_Transformer]] — LogTrans baseline
- [[2023_Challu_NHiTS_Neural_Hierarchical_Interpolation]] — N-HiTS MLP-based baseline
- [[2020_Salinas_DeepAR_Probabilistic_Forecasting]] — M5 comparison baseline
- Gu et al., S4 (ICLR) — structured state-space comparison
- [[2017_Attention_Is_All_You_Need]] — Transformer origin
- [[1997_Hochreiter_Long_Short_Term_Memory]] — LSTM baseline
