...
- Cited Foundations in Vault: [[2017_Attention_Is_All_You_Need]] [VSP+17] — Transformer base; [[2022_RevIN_Reversible_Instance_Normalization]] [KKT+21] — normalization; [[2023_PatchTST_A_Time_Series_is_Worth_64_Words]] [NNSK22] — patching inspiration; [[2023_DLinear_Are_Transformers_Effective_LTSF]] [ZCZX23] — one-shot vs AR decoding; [[2024_TiDE_Long_Term_Forecasting]] [DKL+23] — residual block design; [[2021_Informer_Beyond_Efficient_Transformer]] [ZZP+21] — ETT benchmark; [[2021_Autoformer_Decomposition_Transformers_AutoCorrelation]] [WXWL21]; [[2022_GCN_TRN_EV_Availability]]-adjacent FEDFormer [ZMW+22]; [[2023_TimesNet_Temporal_2D_Variation_Modeling]]; [[2018_Empirical_TCN_Sequence_Modeling]] [BBO17]; [[2020_NBEATS_Interpretable_Time_Series_Forecasting]] [OCCB19]; [[2020_DeepAR_Probabilistic_Forecasting]] [SFGJ20]; [[2023_Treatment_Effects_Continuous_Time_Hidden_Confounders]]-adjacent TimeGPT-1 [GMC23]; LLMTime [GFQW23]; Scaling laws [KMH+20][HBM+22]; Mamba [GD23]
- Related Vault Papers: [[2025_Benchmark_Foundation_Models]] — benchmarks [[TimesFM]] / [[TimesFM_2.0]] zero-shot vs TFS Transformers on household STLF; [[2024_TiDE_Long_Term_Forecasting]] — same first author, TiDE dense encoder alternative; [[2019_Deep_Probabilistic_Scheduling_Power_Markets]] — probabilistic load forecasting context

> [!IMPORTANT]
> **For Thesis Use**: This is the *origin paper* for [[TimesFM]] — the decoder-only TSFM now benchmarked in [[2025_Benchmark_Foundation_Models]] and referenced in [[Hong_SSM_Transformer_LSTM_Grid_Benchmark]]. Its univariate, covariate-free design explains why Meyer et al. find TSFMs only competitive with <4 weeks history and why EV-specific extensions (arrival/departure, SoC, tariff, weather+traffic fusion via cross-attention) remain an open gap — see [[research_gaps]] T-2/T-3.

## Extracted Reference Dump
Full extracted bibliography for this paper: [[2024_TimesFM_Decoder_Only_Foundation_Model_refs]]
