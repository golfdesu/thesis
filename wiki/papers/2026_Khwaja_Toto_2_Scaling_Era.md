...
- Cited Foundations in Vault: [[2017_Attention_Is_All_You_Need]] [VSP+17]; [[2023_Nie_PatchTST_A_Time_Series_is_Worth_64_Words]] [NNSK22] (patched predecessor); [[2022_Kim_RevIN_Reversible_Instance_Normalization]]-adjacent robust scaling; [[2014_Kingma_Adam_Stochastic_Optimization]] [Kingma & Ba 2017] / [[2022_Liu_KAN_Kolmogorov_Arnold_Networks]]-adjacent; [[2020_Salinas_DeepAR_Probabilistic_Forecasting]]-adjacent SMM; [[2024_Das_TimesFM_Decoder_Only_Foundation_Model]] as contemporaneous TSFM; [[2024_Ahamed_TimeMachine_Mamba_Long_Term_Forecasting]]/[[2024_Liang_BiMamba_Bidirectional_Mamba_Forecasting]]/[[2026_Lahoti_Mamba_3_Sequence_Modeling]] (xLSTM/SSM context for CPM origin).
- Related Vault Papers: [[2024_Das_TimesFM_Decoder_Only_Foundation_Model]] — decoder-only patched predecessor beaten on all 3 benchmarks; direct comparison in Fig. 1 (TimesFM-2.5/2.0 vs Toto 2.0 family Pareto); [[2025_Meyer_Benchmark_Foundation_Models]] — benchmarks TimesFM/Chronos/Moirai on household STLF (Toto not yet included); [[2026_Ahamed_TimeMachine_Mamba_Long_Term_Forecasting]] / [[2026_Lahoti_Mamba_3_Sequence_Modeling]] — SSM alternatives to Transformer backbone; [[2024_Zhong_V2G_SVE_Evaluation_Metric]] — downstream value metric vs CRPS/MASE gap highlighted in Toto 2.0 §6.
...
Full extracted bibliography for this paper: [[2026_Khwaja_Toto_2_Scaling_Era_refs]]
