...
- [[2022_RevIN_Reversible_Instance_Normalization]] — RevIN [27], the reversible instance normalization this work explicitly critiques for assuming a time-invariant transitional distribution; JointPGM outperforms RevIN-augmented backbones in Table III/VI.
...
- Related vault lines: [[2019_EV_Load_Forecasting]], [[2020_Ensemble_EV_Load]], [[2026_Hybrid_XGBoost_BiLSTM_EV_Load]] — application-domain counterparts whose EV load series exhibit exactly the kind of non-stationarity/transitional shift this method targets.
