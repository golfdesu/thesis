...
- **Calendar features**: weekday type (weekday/weekend/holiday) — cyclical/calendar feature usage connects to [[2021_VanKriekinge_Day_Ahead_EV_Demand]], which likewise encodes day-type/cyclic calendar effects for day-ahead EV demand.
...
- Related vault papers: [[2021_VanKriekinge_Day_Ahead_EV_Demand]] (↔ shared use of cyclical/calendar/day-type features for station-level EV demand), [[2024_Huo_Data_Driven_EVCS_Demand_Forecasting]] (pure-autoregressive counterpart on public ACN data), [[2024_Ma_LASSO_BPNN_Mid_Term_EV_Load]] (alternative exogenous-feature route via LASSO screening).
