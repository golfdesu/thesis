...
- Cites [[Graph_WaveNet]] (Wu et al., ref [9]) and spatio-temporal GCNs (Yu et al., STGCN, ref [8]) as the ML spatio-temporal line it positions against → see also [[GCN]], [[2019_Wu_Graph_WaveNet_Spatial_Temporal_Modeling]].
