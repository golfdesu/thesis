...
- Koohfar et al. (2023), Transformer-based EV charging demand on 5 years of Boulder data, Sustainability 15(3):2105 → vault: [[2023_Transformer_EV_Demand]].
- Zhu et al. (2019), deep learning (LSTM/GRU/ANN) EV load comparison, Appl. Sci. 9(9):1723 → vault: [[2019_EV_Load_Forecasting]] / [[2019_STLF_EVCS_Deep_Learning]].
...
- Cho et al. (2014), GRU, arXiv:1406.1078; Hochreiter & Schmidhuber (1997), LSTM → vault: [[1997_Long_Short_Term_Memory]]; Vaswani et al. (2017), Transformer → vault: [[2017_Attention_Is_All_You_Need]]; Chen & Guestrin (2016), XGBoost, KDD:785–794.
