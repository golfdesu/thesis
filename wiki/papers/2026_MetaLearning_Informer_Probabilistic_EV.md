...
- [[2021_Informer_Beyond_Efficient_Transformer]] — base Informer architecture, ProbSparse attention, generative decoder (ref. [8])
- [[2017_MAML_Model_Agnostic_Meta_Learning]] — MAML bi-level optimization (ref. [26])
- [[2018_Reptile_First_Order_Meta_Learning]] — Reptile baseline (Reptile-Informer in Table 4)
- [[2017_Attention_Is_All_You_Need]] — scaled dot-product/multi-head attention (refs. [7])
- [[2020_DeepAR_Probabilistic_Forecasting]] — probabilistic deep forecasting context (ref. [20])
- [[2021_TFT_Temporal_Fusion_Transformers]] — TFT probabilistic multi-horizon baseline family (ref. [6])
- Related vault EV probabilistic/meta-learning work: [[2023_MetaProbformer_EV_Load]], [[2025_QR_LSTM_Attention_EV_Load]] (QR+LSTM probabilistic EV forecasting, ref. [34]), [[2024_DiffPLF_Conditional_Diffusion_EV]], [[2025_Meta_Learning_Physics_Informed_GACN_Power_System]], [[2024_MQ_TCN_Transfer_Learning_EV]]
- Dataset-overlapping vault papers: [[2025_Hybrid_LSTM_Transformer_Demand]] ([[Caltech_ACN]]), [[2020_Ensemble_EV_Load]] & [[2024_Autoformer_EV_Charging]] ([[Boulder_Colorado]]), [[2024_EV_Load_Forecasting_DAM]] ([[Palo_Alto_EV]])
