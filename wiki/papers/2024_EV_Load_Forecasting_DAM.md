...
3. **Nine residual forecasting models** (trend component held fixed for fairness):
   ...
   - DL: CNN-Dense$_{sc}$ and CNN-LSTM$_{sc}$ ([[2018_Empirical_TCN_Sequence_Modeling|conv]] filters 64–128, kernel 4–8, LSTM units 32–128); [[TCN]]$_{sc}$ (filters 128–256, dilations [1,2,4,8,16,32]); all with 168 lags, lr=0.001, early stopping.
...
- [[1997_Long_Short_Term_Memory]] — LSTM within CNN-LSTM hybrid ([43]).
- [[2018_Empirical_TCN_Sequence_Modeling]] — [[TCN]] basis ([44]).
- [[2021_Hierarchical_Probabilistic_EV_Load]] — prior hierarchical probabilistic EV forecasting benchmark ([33]).
