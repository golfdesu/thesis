...
- [[2024_Ahamed_TimeMachine_Mamba_Long_Term_Forecasting]] — [[2024_Ahamed_TimeMachine_Mamba_Long_Term_Forecasting]] (arXiv:2403.09898): quadruple-Mamba multi-scale model; Bi-Mamba+ critiques its heuristic channel-strategy choice and adopts its hyperparameter conventions (d_conv=2, expand=1).
