...
**Multi-head self-attention** (**Eqs. 25–27**, cf. [[2017_Attention_Is_All_You_Need]], [[2019_LogSparse_Enhancing_Locality_Transformer]]):
...
- [[2021_TFT_Temporal_Fusion_Transformers]] — source of GRN/GLU building blocks and TFT benchmark ([32]).
- [[2017_Attention_Is_All_You_Need]] — multi-head self-attention ([35]).
- [[2019_LogSparse_Enhancing_Locality_Transformer]] — attention for long-term relationships in time series ([34]).
- [[2020_DeepAR_Probabilistic_Forecasting]] — DeepAR benchmark and risk metric convention ([36]).
- [[2020_NBEATS_Interpretable_Time_Series_Forecasting]] — NBEATS basis/benchmark ([26]).
- [[2021_Hierarchical_Probabilistic_EV_Load]] — ensemble probabilistic EV load forecasting ([20]).
