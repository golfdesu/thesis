...
- [[2023_PatchTST_A_Time_Series_is_Worth_64_Words]] — SOTA TFS baseline [36]
- [[2024_iTransformer_Inverted_Transformers_Effective_Time_Series]] — TFS baseline [37]
- [[2021_TFT_Temporal_Fusion_Transformers]] — LSTM+attention TFS baseline [38]
- [[2021_TimeGrad_Diffusion_Forecasting]] — same first author as [[LagLlama]]
- Related vault papers: [[2025_Vertical_Federated_EGAT_LSTM]] and [[2025_Personalized_Federated_Learning]] (household-level load forecasting), [[2025_EV_STLLM_Spatio_Temporal_LLM]] (LLM-based EV forecasting)

## Extracted Reference Dump
Full extracted bibliography for this paper: [[2025_Benchmark_Foundation_Models_refs]]
