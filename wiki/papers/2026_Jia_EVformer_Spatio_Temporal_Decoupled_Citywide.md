...
**Related wiki line**: [[2025_Tian_MSSTGAN_City_EV_Load]], [[2024_Shi_Attention_Spatiotemporal_MultiGraph_EV_Load]], [[2025_Fan_EV_STLLM_Spatio_Temporal_LLM]], [[2024_Qu_Physics_Informed_GAT_EV_Load]]
...
- [[2021_Zhou_Informer_Beyond_Efficient_Transformer]] (ref [13]) & [[2021_Wu_Autoformer_Decomposition_Transformers_AutoCorrelation]] (ref [14]) — efficient-attention line the temporal module departs from.
- [[2023_Zhang_Crossformer_Cross_Dimension_Dependency]] (cited as CrossFormer, ref [7]) and [[2024_Liu_iTransformer_Inverted_Transformers_Effective_Time_Series]] (ref [8]) — recent variable-wise/channel-first Transformers motivating the global-aggregation design.
- [[2019_Wu_Graph_WaveNet_Spatial_Temporal_Modeling]] (ref [23]) and MTGNN (ref [22]) — coupled spatio-temporal graph baselines.
- STGCN (ref [15]), DCRNN (ref [16]) — classic graph-based spatio-temporal baselines; GCN [[2022_Zhang_GCN_TRN_EV_Availability]]-style baselines.
...
- **Wiki links**: [[2025_Tian_MSSTGAN_City_EV_Load]] (city-level EV load w/ STE + gated fusion + transform attention — closest architectural sibling), [[2024_Shi_Attention_Spatiotemporal_MultiGraph_EV_Load]] (multi-graph attention EV load), [[2025_Fan_EV_STLLM_Spatio_Temporal_LLM]] (LLM-based spatio-temporal EV forecasting), [[2024_Qu_Physics_Informed_GAT_EV_Load]] (physics-informed GAT EV load).
