...
- Vault papers: [[2017_Attention_Is_All_You_Need]] (vanilla Transformer base), [[2021_Wu_Autoformer_Decomposition_Transformers_AutoCorrelation]] (successor using ETT benchmark + Informer baseline), [[1997_Hochreiter_Long_Short_Term_Memory]] (LSTM/LSTMa baseline), [[2020_Salinas_DeepAR_Probabilistic_Forecasting]] (DeepAR baseline)
