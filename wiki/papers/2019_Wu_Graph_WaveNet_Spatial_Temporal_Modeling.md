...
- Spatial-temporal backbone adopted by EV-station GNN forecasters in the vault: [[2024_Shi_Attention_Spatiotemporal_MultiGraph_EV_Load]], [[2024_Qu_Physics_Informed_GAT_EV_Load]].
- Its WaveNet-style denoising network family is contrasted by [[2023_Wen_DiffSTG_Probabilistic_ST_Graph_Diffusion]] (cites this paper as ref [44] when designing UGnet).
