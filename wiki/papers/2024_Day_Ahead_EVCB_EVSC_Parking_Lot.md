...
- Zhang, Hu, Xu & Song, IEEE Trans. Power Syst. 2017 — aggregate PEV model for achievable V2G capacity [30] (also used by [[2024_V2G_SVE_Evaluation_Metric]])
...
- Zhang, Chan et al., IEEE Trans. Cybernetics 2020 — deep-learning probabilistic EV charging load forecasting with queuing model [25] ([[2021_Probabilistic_Queuing_EV_Load]])
