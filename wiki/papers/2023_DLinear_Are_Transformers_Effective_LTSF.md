...
- Later answered by [[2023_PatchTST_A_Time_Series_is_Worth_64_Words|PatchTST]], which shows patched channel-independent Transformers do beat DLinear when long look-backs are exploited.
...
- [[2021_Informer_Beyond_Efficient_Transformer]] — ProbSparse baseline; ETT dataset source
- [[2021_Autoformer_Decomposition_Transformers_AutoCorrelation]] — decomposition scheme reused in DLinear; baseline
- [[2019_LogSparse_Enhancing_Locality_Transformer]] — LogTrans baseline
- [[2023_TimesNet_Temporal_2D_Variation_Modeling]] — follow-up showing linear models fail on classification/imputation but TimesNet still beats them at forecasting
- [[2023_PatchTST_A_Time_Series_is_Worth_64_Words]] — rebuttal demonstrating effective Transformer design
