...
- Companion minute-level study: [[2019_EV_Load_Forecasting]] (Energies 12(14):2692)
- Foundation: [[1997_Long_Short_Term_Memory|Hochreiter & Schmidhuber, LSTM (1997)]]
- Method sources cited: GRU (Cho et al., arXiv:1409.1259), [[2014_Kingma_Adam_Optimization|Adam (Kingma & Ba, arXiv:1412.6980)]], Adagrad (Duchi et al., 2011), Adadelta (Zeiler, 2012), RMSProp (Tieleman & Hinton, 2012)
- Metric definitions from Willmott et al., J. Geophys. Res. Oceans (1985)

## Extracted Reference Dump
Full extracted bibliography for this paper: [[2019_ApplSci_EV_Load_Forecasting_refs]]
