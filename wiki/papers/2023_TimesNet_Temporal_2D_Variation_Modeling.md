...
- [[2021_Autoformer_Decomposition_Transformers_AutoCorrelation]] — Auto-Correlation inspiration for amplitude-weighted aggregation; benchmark/dataset provider
- [[2021_Informer_Beyond_Efficient_Transformer]] — baseline; ETT dataset source
- [[2023_DLinear_Are_Transformers_Effective_LTSF]] — MLP baseline that fails classification/imputation but strong at fixed-dependency autoregression
- [[2020_NBEATS_Interpretable_Time_Series_Forecasting]] — short-term M4 baseline & metric protocol (SMAPE/MASE/OWA)
- [[2023_NHiTS_Neural_Hierarchical_Interpolation]] — short-term forecasting SOTA baseline
