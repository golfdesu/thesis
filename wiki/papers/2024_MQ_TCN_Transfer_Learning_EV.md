...
- [[2018_Empirical_TCN_Sequence_Modeling]] — TCN architecture (dilated causal conv + residual blocks) that MQ-TCN extends
- [[2020_DeepAR_Probabilistic_Forecasting]] — probabilistic autoregressive baseline
- [[2021_Day_Ahead_EV_Demand]] — cited day-ahead DNN EV charging demand forecasting (LSTM, calendar/weather)
- [[2023_Transformer_EV_Demand]] — cited transformer-based e-mobility demand forecasting
- [[2023_MetaProbformer_EV_Load]] — related probabilistic/meta-learning EV charging forecasts (MBQFN context)
- [[2017_QRA_Sister_Forecasts_Probabilistic_Load]] — quantile-regression probabilistic load forecasting lineage

## Extracted Reference Dump
Full extracted bibliography for this paper: [[2024_MQ_TCN_Transfer_Learning_EV_refs]]
