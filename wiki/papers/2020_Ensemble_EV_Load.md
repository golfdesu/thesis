...
- [[1997_Long_Short_Term_Memory]] — LSTM foundation (ref. [14])
- [[2014_Kingma_Adam_Optimization]] — Adam optimizer for ANN/LSTM
- [[2019_EV_Load_Forecasting]] — Zhu et al., comparative deep learning study for EV charging stations (refs. [17], [18])
- [[2021_RL_Q_Learning_EV_Load]] — Q-learning-based EV charging load forecasting (ref. [19])
- Sutskever et al. (2014) — sequence-to-sequence learning (ref. [12])

## Extracted Reference Dump
Full extracted bibliography for this paper: [[2020_Ensemble_EV_Load_refs]]
