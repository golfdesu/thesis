...
- Probabilistic baselines: [[2020_DeepAR_Probabilistic_Forecasting]] (Flunkert et al.), DeepState (Rangapuram et al., NeurIPS 2018)
- Downstream efficient Transformers in vault: [[2021_Informer_Beyond_Efficient_Transformer]], [[2021_Autoformer_Decomposition_Transformers_AutoCorrelation]], [[2023_PatchTST_A_Time_Series_is_Worth_64_Words]]
- Other cited anchors: WaveNet (van den Oord et al., 2016 — causal convolutions), Sparse Transformers (Child et al., arXiv:1904.10509), TRMF (Yu et al., NeurIPS 2016), [[2014_Kingma_Adam_Optimization]]
